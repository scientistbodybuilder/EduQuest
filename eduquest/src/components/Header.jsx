...
const Header = () => {
    ...
    return(
        <div className='w-full top-0 h-16 flex items-center justify-between shadow-md border-b-3 border-[#ccc] px-4 py-1 bg-[#2D3D73]'>
            <Link to="/">
            ...
            <div className='flex items-center justify-center gap-3 xl:gap-5'>
                ...
                <h3 onClick={()=>signOut()} className='cursor-pointer font-medium xl:text-xl md:text-lg text-base text-white'>Sign Out</h3>
            </div>)
            : null
            }
